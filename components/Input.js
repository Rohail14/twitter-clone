...
import { addDoc,collection,doc,serverTimestamp,updateDoc,setDoc,getDoc } from '@firebase/firestore';
     ...
     ${loading && 'opacity-60'}`}>
        ...
        <div className='w-full divide-y divide-gray-700'>
            <div className={`${selectedFile && 'pb-7'} ${input && 'space-y-2.5'}`}>
                ...
                rows='2'
                className='no-scrollbar bg-transparent outline-none text-[#d9d9d9] text-lg placeholder-gray-500
            ...
            {!loading && (
                ...
                <div className='flex items-center justify-between pt-2.5'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <input type='file' className='hidden' onChange={addImageToPost} ref={filePickerRef}/>
                    ...
                    <button className='bg-[#1d9bf0] text-white rounded-full px-4 py-1.5 w-28 shadow-md
