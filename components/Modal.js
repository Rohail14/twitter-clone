...
const sendComment = async(e) => {
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as='div' className='fixed z-50 inset-0 pt-8'
      onClose={setIsOpen}>
                ...
                <div className='w-full'>
                  <div className='text-[#6e767d] flex gap-x-3 relative'>
                    ...
                    <div>
                      ...
                      <p className='text-[#d9d9d9] text-[15px] sm:text-base py-2'>{post?.text}</p>
                    </div>
                  </div>
                  ...
                  <div className='mt-7 flex space-x-3 w-full'>
                    ...
                    <textarea 
                      ...
                      <div className='flex items-center justify-between pt-2.5'>
                          ...
                          <button
                            className='bg-[#1d9bf0] text-white rounded-full px-4 py-1.5 w-28 shadow-md
